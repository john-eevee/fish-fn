function open_project --description "Open a project in the current editor"
...
function post_project_cd --description "Actions to perform after changing to a project directory"
    ...
    switch $project_type
        case node
            type -q on_node_callback; and on_node_callback
        case java-maven
            type -q on_java_callback; and on_java_callback
        case java-gradle
            type -q on_java_callback; and on_java_callback
        case python
            type -q on_python_callback; and on_python_callback
        case elixir
            type -q on_elixir_callback; and on_elixir_callback
        case flutter
            type -q on_flutter_callback; and on_flutter_callback
        case '*'
...
function get_project_type --description "Determine the type of project in the current directory"
    if test -f "package.json"
        ...
        echo java-gradle
    else if test -f "setup.py"; or test -f "pyproject.toml"
        echo python
